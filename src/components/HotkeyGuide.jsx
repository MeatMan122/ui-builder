  ...
  return (
    <div className="hotkey-guide">
      <div className="panel-header">
        <span>Shortcuts</span>
        <span className="panel-header-separator" />
        <a className="hotkey-github-link" href="https://github.com/MeatMan122/ui-builder" target="_blank" rel="noopener noreferrer" title="View on GitHub">
